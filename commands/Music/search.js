...
module.exports = {
  ...
  var songInfo = video
   ...
   const queueConstruct = {
    ...
    if (!song){
      if (!online.afk) {
        sendError("Oops I think there are no songs in the queue", message.channel)
        message.guild.me.voice.channel.join();//If you want your bot stay in vc 24/7 remove this line :D
